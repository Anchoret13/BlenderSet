...
class SetupUtility:
    ...
    @staticmethod
    def setup(user_required_packages=None, blender_path="/home/dyf/blender/blender-2.93.0-linux-x64", major_version="2.93", reinstall_packages=False, debug_args=None):
